...
Command: npx gltfjsx@6.5.3 public/cyber_desk.glb 
...
export function Model(props) {
  const { nodes, materials } = useGLTF(`${import.meta.env.BASE_URL}cyber_desk.glb`)
  return (
...
useGLTF.preload(`${import.meta.env.BASE_URL}cyber_desk.glb`)