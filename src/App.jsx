        ...
        <div style={{
          ...
          {activeSection === 'projects' && (
            <div>
              ...
              {/* Project 1: Mustard's Rental Car Services */}
              <div style={{ background: 'rgba(0, 0, 0, 0.4)', padding: '15px', borderRadius: '8px', border: '1px solid rgba(0, 216, 255, 0.4)', marginBottom: '15px' }}>
                <h3 style={{ margin: '0 0 5px 0', color: '#00D8FF', fontFamily: '"Segoe UI", sans-serif', fontSize: isMobile ? '1.15rem' : '1.3rem' }}>🚗 Mustard's Rental Car Services</h3>
                <p style={{ margin: '0 0 10px 0', color: '#ffffff', fontSize: isMobile ? '0.85rem' : '0.95rem', fontFamily: '"Segoe UI", sans-serif', lineHeight: '1.5' }}>
                  Full-stack vehicle rental operations & booking portal with real-time fleet tracking, 50+ preset cars, PIN-protected admin controls, and CSV revenue reporting.
                </p>
                <div style={{ display: 'flex', gap: '15px' }}>
                  <a href="https://mustards-car-rental.vercel.app/" target="_blank" rel="noopener noreferrer" style={{ color: '#00D8FF', fontWeight: 'bold', textDecoration: 'none', fontSize: '0.85rem' }}>Live Demo ↗</a>
                  <a href="https://github.com/mustard-collab/mustards-car-rental" target="_blank" rel="noopener noreferrer" style={{ color: 'rgba(255,255,255,0.7)', fontWeight: 'bold', textDecoration: 'none', fontSize: '0.85rem' }}>GitHub ↗</a>
                </div>
              </div>

              {/* Project 2: ContextIQ */}
              <div style={{ background: 'rgba(0, 0, 0, 0.4)', padding: '15px', borderRadius: '8px', border: '1px solid rgba(153, 77, 255, 0.4)', marginBottom: '15px' }}>
                <h3 style={{ margin: '0 0 5px 0', color: '#994DFF', fontFamily: '"Segoe UI", sans-serif', fontSize: isMobile ? '1.15rem' : '1.3rem' }}>ContextIQ</h3>
                <p style={{ margin: '0', color: '#ffffff', fontSize: isMobile ? '0.85rem' : '0.95rem', fontFamily: '"Segoe UI", sans-serif', lineHeight: '1.5' }}>AI-powered Chrome extension and backend platform for the Devpost Google Gemini Hackathon.</p>
              </div>

              {/* Project 3: Management Systems */}
              <div style={{ background: 'rgba(0, 0, 0, 0.4)', padding: '15px', borderRadius: '8px', border: '1px solid rgba(0, 216, 255, 0.4)' }}>
                <h3 style={{ margin: '0 0 5px 0', color: '#00D8FF', fontFamily: '"Segoe UI", sans-serif', fontSize: isMobile ? '1.15rem' : '1.3rem' }}>Bank & Airline Management Systems</h3>
                <p style={{ margin: '0', color: '#ffffff', fontSize: isMobile ? '0.85rem' : '0.95rem', fontFamily: '"Segoe UI", sans-serif', lineHeight: '1.5' }}>Robust, secure command-line applications developed entirely in C for core logic handling.</p>
              </div>
            </div>
          )}
          ...
          {activeSection === 'contact' && (
            <div>
              ...
              <div style={{ display: 'flex', gap: '15px', marginTop: '20px', justifyContent: 'center' }}>
                ...
                <a href="https://www.linkedin.com/in/muhammad-mustafa11" target="_blank" rel="noopener noreferrer" 
